...
const CommentSection = () => {
    return (
        <section className=" py-8 lg:py-16 px-40 mx-auto " style={{ backgroundImage: "url('public/img/Banner/banner_bg.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us</h2>
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Premium plan? Let us know.</p>
